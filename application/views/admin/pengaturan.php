      ...
      <div class="content-wrapper">
        <div class="row">
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Edit Akun <?= $active ?></h4>
                <?php echo $this->session->flashdata('msg');?>
                <div class="col-18">
                  <div class="card">
                    <form class="forms-sample" method="post" enctype="multipart/form-data" action="<?= base_url().'admin/e_akun' ?>">
                    ...
                    <form class="forms-sample" method="post" action="<?= base_url()?>admin/ganti_password/pengaturan">
                      <div class="form-group row">
                      ...
                      <a href="<?= base_url().'admin/' ?>" class="btn btn-light"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </form>
                    <br /><br /><br />
                    <h4 class="card-title">Reset Password</h4>
                    <form class="forms-sample">
                      <a href="#" data-toggle='modal' data-target='#reset_password<?= $data_user_login->nip;?>' class="btn btn-danger" class="btn btn-danger mr-2">Reset</a>
                    </form>
                  </div>
                </div>
              </div>
...
<div class="modal fade" id="reset_password<?= $data_user_login->nip;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" method="post" action="<?= base_url().'admin/resetpassword/pengaturan'?>">
        <div class="modal-body">
          <b>Anda yakin ingin mereset password?</b><br><br>
          <input type="hidden" name="nip" value="<?= $data_user_login->nip;?>">
