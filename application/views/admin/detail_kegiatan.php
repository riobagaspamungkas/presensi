              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <table align="center">
                    <tr>
                      <td>
                        <a href="<?= base_url() ?>admin/monitoring" class="btn btn-secondary">Kembali</a>
                      </td>
                    </tr>
                  </table>
                  <br>
                    ...
                    <tr>
                      <td class="summary-heading">File Lampiran Kegiatan :
                        ...
                        if ($desk_kegiatan->lampiran) {?>
                          <button class="btn btn-link" onclick="window.open('<?= base_url().'admin/tampil_kegiatan/'. $desk_kegiatan->lampiran?>')"> File </button>
                        <?php 
                        }else{
                          echo '-';
                        }
