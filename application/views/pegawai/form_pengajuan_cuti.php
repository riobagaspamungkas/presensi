...
$date_akhir = date('Y-m-d', strtotime($tambah_bulan, strtotime( $date_awal )));
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-18">
                    <div class="card">
                      <form class="forms-sample" method="post" enctype="multipart/form-data" action="<?= base_url()?>pegawai/t_pengajuan_cuti">
                        <div class="form-group row">
                          <label for="nip" class="col-sm-2 col-form-label">NIP</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="jenis_cuti" value="<?= $id_jenis_cuti ?>" hidden>
                            <input type="text" class="form-control" name="nip" value="<?= $data_user_login->nip ?>" readonly>
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label for="keterangan" class="col-sm-2 col-form-label">Alasan Cuti</label>
                          <div class="col-sm-9">
                            <textarea type="text" class="form-control" name="alasan" placeholder="Masukkan Alasan Cuti" required></textarea>
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <a href="<?= base_url()?>pegawai/pengajuan_cuti" class="btn btn-light"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                      </form>
                    </div>
                  </div>
                </div>
