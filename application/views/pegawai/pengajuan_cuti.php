                  ...
                  <table class="table table-striped table-bordered table-list">
                    ...
                    <tbody>
                      ...
                      foreach ($getdatapengajuan as $row){
                        ...
                        ?>
                        <td align="center">
                          <a href="<?= base_url().'pegawai/update_pengajuan_cuti/'.$time?>" class="btn btn-primary"><em class="mdi mdi-table-edit"></em></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        foreach($listcuti->result() as $j){ ?>
          <a href="<?= base_url() ?>pegawai/form_pengajuan_cuti/<?= $j->id_jenis_cuti ?>" class="col-sm-10 btn btn-primary"><?= ucwords($j->jenis_cuti) ?></a><br><br>
        <?php } ?>
      </div>
...
<?php 
  ...
  <div class="modal fade" id="konfirmasi_hapus<?php echo $time;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" action="<?= base_url().'pegawai/hapus_pengajuan_cuti'?>">
          <div class="modal-body">
