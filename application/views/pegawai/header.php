    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item <?php if($active == 'pengajuan_cuti' || $active == 'pengajuan_dl' || $active == 'histori') echo 'active' ?>">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="<?php if($active == 'pengajuan_cuti' || $active == 'pengajuan_dl' || $active == 'histori') echo 'true' ?>" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-clipboard-text"></i>
              <span class="menu-title">Izin / Cuti</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse <?php if($active == 'pengajuan_cuti' || $active == 'pengajuan_dl' || $active == 'histori') echo 'show' ?>" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link <?php if($active == 'pengajuan_cuti') echo 'active' ?>" href="<?= base_url().'pegawai/pengajuan_cuti'?>">Pengajuan Cuti</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?php if($active == 'pengajuan_dl') echo 'active' ?>" href="<?= base_url().'pegawai/pengajuan_dl'?>">Pengajuan DL</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?php if($active == 'histori') echo 'active' ?>" href="<?= base_url().'pegawai/histori'?>">History</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item <?php if($active == 'kegiatan' || $active == 'monitoring') echo 'active' ?>">
            ...
            <div class="collapse <?php if($active == 'kegiatan' || $active == 'monitoring') echo 'show' ?>" id="kegiatan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link <?php if($active == 'kegiatan') echo 'active' ?>" href="<?= base_url().'pegawai/kegiatan'?>">Tambah Kegiatan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?php if($active == 'monitoring') echo 'active' ?>" href="<?= base_url().'pegawai/monitoring'?>">Monitoring</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item <?php if($active == 'pengaturan') echo 'active' ?>">
            <a class="nav-link" href="<?= base_url().'pegawai/pengaturan'?>">
              <i class="menu-icon mdi mdi-account-settings-variant"></i>
              <span class="menu-title">Pengaturan</span>
            </a>
          </li>
          <li class="nav-item <?php if($active == 'about') echo 'active' ?>">
            <a class="nav-link" href="<?= base_url().'pegawai/about'?>">
