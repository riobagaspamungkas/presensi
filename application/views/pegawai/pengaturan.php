          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-18">
                  <div class="card">
                    <form class="forms-sample" method="post" enctype="multipart/form-data" action="<?= base_url().'pegawai/e_akun' ?>">
                    ...
                    <form class="forms-sample" method="post" action="<?= base_url()?>pegawai/ganti_password/pengaturan">
                      <div class="form-group row">
                      ...
                      <a href="<?= base_url().'pegawai/' ?>" class="btn btn-light"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </form>
                  </div>
                </div>
              </div>
