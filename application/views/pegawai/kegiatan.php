...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data" action="<?= base_url()?>pegawai/tambah_kegiatan">
                      ...
                      <table class="table table-striped table-bordered table-list" id="tableData">
                        ...
                        <tbody style="text-align:center">
                          ...
                          foreach ($kegiatan as $row) {
                            ...
                            ?>
                            <td align="center">
                              <a href="<?= base_url() ?>pegawai/detail_kegiatan/<?= $row->id_deskripsi;?>" class="btn btn-dark"><em class="mdi mdi-information-outline"></em></a>
                              <a href="<?= base_url().'pegawai/update_kegiatan/'.$row->id_deskripsi?>" class="btn btn-primary"><em class="mdi mdi-table-edit"></em></a>
    ...
    <div class="modal fade" id="konfirmasi_hapus<?php echo $id_deskripsi;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form class="form-horizontal" method="post" action="<?= base_url().'pegawai/hapus_kegiatan'?>">
  ...
  <script type="text/javascript">
    $("#datepicker").datepicker({
      ...
      $.ajax({
        url : "<?= base_url() ?>pegawai/data_kegiatan",
        type : "POST",
        cache: false,
        data : {date: date},
