            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-xs-12 col-md-12 col-lg-12">
                  <a href="<?= base_url() ?>kepala/form_pengajuan_dl" style="float: right;" class="btn btn-secondary"><em class="mdi mdi-plus"></em> Tambah Permohonan</a><br>
                </div>
                <br>
                  ...
                  <table class="table table-striped table-bordered table-list">
                    ...
                    <tbody>
                      ...
                      foreach ($getdatapengajuan as $row){
                        ...
                        ?>
                        <td align="center">
                          <a href="<?= base_url().'kepala/update_pengajuan_dl/'.$time?>" class="btn btn-primary"><em class="mdi mdi-table-edit"></em></a>
  ...
  <div class="modal fade" id="konfirmasi_hapus<?php echo $time;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" action="<?= base_url().'kepala/hapus_pengajuan_dl'?>">
