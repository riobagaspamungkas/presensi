                ...
                <div class="table-responsive">
                  ...
                  <table align="center">
                    <tr>
                      <td>
                        ...
                        <a href="<?= base_url() ?>kepala/persetujuan" class="btn btn-secondary">Kembali</a>
                      </td>
                    </tr>
                  </table>
                  </br>
                  <table class="table table-hover table-border">
                    <tr>
                      ...
                      <a href="#" type="text" onclick="window.open('<?= base_url().'kepala/tampil/dl/'.$getdatapengajuan->bukti?>')"> File </a></td>
                    </tr>
                  </table>
                </div>
              </div>
...
<div class="modal fade" id="setuju" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" method="post" action="<?= base_url().'kepala/t_persetujuan_dl'?>">
