        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Persetujuan Permohohan Izin / Cuti</h4>
                  <br>
                      ...
                      <tbody>
                        ...
                        foreach ($persetujuan as $row) {
                          ...
                          <tr>
                            ...
                            <td align="center">
                              <a href="<?= base_url() ?>kepala/s_persetujuan/<?= $time;?>/<?= $row->tabel;?>" class="btn btn-primary">Persetujuan</a>
                            </td>
                          </tr>
                          <?php $no++;
                        } ?>
  ...
  <script type="text/javascript">
    $( document ).ready(function() {
      $('#cuti_dl').change(function() {
        ...
        $.ajax({
          url: "<?= base_url() ?>kepala/data_persetujuan",
          type: "POST",
          cache:false,
